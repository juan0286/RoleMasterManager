<%-- 
    Document   : jugadorItem.jsp
    Created on : 09-nov-2017, 13:53:47
    Author     : TiranoJuan
--%>
            ...
            <c:forEach items="${campaActual.getJugadores()}" var="jugador" >
                ...
                <div class="fullcard mdl-card mdl-shadow--4dp">
                    ...
                    <div class="mdl-card__supporting-text">
                        <meter min="0" max="100"
                               low="25" high="75"
                               optimum="100" value="75">Algo</meter>
                                    ...
                                    <div class="pjitem">
                                        <table class="pjtable" border="0"  width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2" ><a href="${campaActual.nombre}/bonoExp/${pj.getId_pj()}">Dar Exp</a></td>
                                            </tr>
                                            <tr>
